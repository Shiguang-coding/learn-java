>在线视频：[尚硅谷2024最新Java入门视频教程(下部)-JDK新特性](https://www.bilibili.com/video/BV1JZ421a7PX?p=177)
...
![image-20240917233702288](images/66e9a21ce4aab.png)
...
![image-20240917234122222](images/66e9a320d0a2f.png)
...
![image-20240917234303489](images/66e9a3861d9ea.png)
...
![image-20240918104156099](images/66ea3df2678c2.png)
...
### Stream中的forEach方法: void forEach(Consumer<? super T> action);
...
### Stream中的Stream\<T> filter(Predicate<? super T> predicate)方法
...
![image-20240918113341528](images/66ea4a13d4cf6.png)
...
![image-20240918113357150](images/66ea4a2370971.png)
...
![image-20240918113404566](images/66ea4a2ad40f4.png)
...
![image-20240918121440023](images/66ea53b065ec7.png)

而Java 9的API，模块是顶级的封装，模块之下才是包，如java.base模块，Java 9的API中Java SE部分的模块结构如图所示。

![image-20240918121447521](images/66ea53b7d2df3.png)
